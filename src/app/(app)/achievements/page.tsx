  ...
  return (
    <div className="px-5 lg:px-8 pt-10 lg:pt-8 fade-in">
      ...
      <div className="glass-card rounded-2xl p-5 mb-5 text-center">
        ...
        <p className="text-3xl font-extrabold" style={{ fontFamily: 'Sora' }}>{streak}</p>
      ...
      {tab === 'today' && (
        <div className="flex flex-col gap-2.5 mb-8">
          <h2 className="text-sm font-bold" style={{ fontFamily: 'Sora' }}>Today&apos;s Challenges</h2>
          {challenges.map((c) => (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5 mb-8">
          {achievements.map((a) => (
            <div key={a.id} className={`glass-card rounded-xl p-3.5 text-center transition-all ${a.unlocked ? '' : 'opacity-35 grayscale'}`}>
              ...
              <p className="text-xs font-bold" style={{ fontFamily: 'Sora' }}>{a.title}</p>
      ...
      {tab === 'share' && (
        <div className="flex flex-col gap-4 mb-8">
          <div className="glass-card rounded-xl p-4">
            <h3 className="text-sm font-bold mb-2 flex items-center gap-2" style={{ fontFamily: 'Sora' }}>
              <Share2 size={14} /> Share Your Progress
            </h3>
            <pre className="text-xs p-3 rounded-lg whitespace-pre-wrap leading-relaxed" style={{ background: 'var(--bg-elevated)', color: 'var(--text-secondary)', fontFamily: 'DM Sans' }}>
              {generateShareText()}
            </pre>
