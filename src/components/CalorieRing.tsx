    ...
    <div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span
          ...
          style={{ fontFamily: 'Bricolage Grotesque, sans-serif', color: over ? 'var(--rose)' : 'var(--text-primary)' }}
        >
          {consumed.toLocaleString()}
        </span>
        <span className="text-[11px] text-[var(--text-muted)] mt-0.5 font-medium" style={{ fontFamily: 'IBM Plex Mono, monospace' }}>
          kcal consumed
        </span>
